...
//  Femboy Dating
//
//  Created by Christian Kinyon on 11/15/23.
//
...
class RegisterViewController: UIViewController {
    ...
    private let firstNameField: UITextField = {
        ...
        field.leftView = UIView(frame: CGRect(x: 0, y: 0, width: 0, height: 0))
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManager.shared.userExists(with: email, completion: { [weak self] exists in
            ...
            guard !exists else {
                // user already exists
                strongSelf.alertUserLoginError(message: "Looks like a user account for that email addresss already exists.")
